...
function Footer() {
  return (
    <footer className="bg-light text-center text-lg-start" style={{ fontFamily: 'Poppins, Arial, sans-serif', fontWeight:'500', boxShadow: '0px -2px 5px rgba(0, 0, 0, 0.1)' }}>
      <div className="text-center p-3" style={{ backgroundColor: 'rgba(255, 255, 255, 0.8)' }}>
